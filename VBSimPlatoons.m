...
% As of 15/5/21 VBSimPlatoons is born as the outdated version of VBSim...
% Platoons can be simulated with this older version, or a future version
% where the platoons are generated in SUMO
% VBSimPlatoons will work without platoons - it will be the only way to use
% the "Complete" Input method going forward.
