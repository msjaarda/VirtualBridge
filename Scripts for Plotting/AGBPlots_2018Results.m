...
for i = 1:3
    ...
    if i == 1
            plot([0 1],[0 1],'-s','Color','r','MarkerEdgeColor','none','MarkerFaceColor','r','MarkerSize',MSize)
    plot([0 1],[0 1],'-s','Color','k','MarkerEdgeColor','k','MarkerFaceColor','none','MarkerSize',MSize)
    ...
    if PlotMargins
        ...
        if PlotOriginal
            ...
            EUpdated = (1.5/(GammaS))*(0.7*Y.EQ1 + 0.5*Y.EQ2 + alphasq*Y.Eq);
