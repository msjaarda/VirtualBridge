...
SumTab.(Folder_Namex) = struct2table(File_List);
SumTab.(Folder_Namex)(:,2:end) = [];
SumTab.(Folder_Namex).Properties.VariableNames{'name'} = 'FName';
SumTab2 = [];
...
SumTab.(Folder_Namex) = [SumTab.(Folder_Namex) SumTab2];
clear File_List
clear OInfo
clear SumTab2
